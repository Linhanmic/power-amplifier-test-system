    ...
    with app.app_context():
        ...
        test_scripts = [
            TestScript(script_code='SCR-001', title='功放开关机测试脚本', script_path='specs/power_control.spec',
                      script_type='spec', gauge_framework=True, tags=json.dumps(['功放', '开关机']), status='active'),
            TestScript(script_code='SCR-002', title='音量控制测试脚本', script_path='specs/volume_control.spec',
                      script_type='spec', gauge_framework=True, tags=json.dumps(['功放', '音量']), status='active'),
            TestScript(script_code='SCR-003', title='蓝牙音频播放脚本', script_path='specs/bluetooth_audio.spec',
                      script_type='spec', gauge_framework=True, tags=json.dumps(['蓝牙', '音频']), status='active'),
        ]
        ...
        # 17. 测试用例
        test_cases = [
            TestCase(case_code='TC-PA-001', group_id=sub_groups[0].id, title='功放开机功能测试',
