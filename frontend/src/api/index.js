...
export const playbackMatrixApi = {
  ...
  // 矩阵条目
  createEntry: (data) => request.post('/playback-matrix-entries', data),
  updateEntry: (id, data) => request.put(`/playback-matrix-entries/${id}`, data),
  deleteEntry: (id) => request.delete(`/playback-matrix-entries/${id}`)
}
